...
public class SurveysListActivity extends MyActivity {
    ...
    BroadcastReceiver syncReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equalsIgnoreCase(SyncScheduler.BROADCAST_LISTING_SYNCED)) {
                ...
                if (dbHandler == null)
                    dbHandler = Database.getInstance(SurveysListActivity.this);
                init();
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_surveyslist);
        setDrawer(this,"List of Surveys in Block");
    ...
    public void start(View view) {
        ...
        final Intent intent = new Intent(SurveysListActivity.this, ListActivity.class);
        intent.putExtra(Constants.EXTRA.IDX_BLOCK, mBlock);
        startActivity(intent);
        finish();
    }
